"""recreate_performance_indexes

Revision ID: h123456789ab
Revises: e922011468f0
...
down_revision: Union[str, None] = 'e922011468f0'
...
def upgrade() -> None:
    """
    Recreate performance indexes that were missing from the database.
