...
class GeminiIncidentClassifier:
    ...
    def _build_prompt(self, description: str) -> str:
        ...
        return (
            ...
            "- IMPORTANT: Set is_ambiguous=true ONLY when you CANNOT analyze or deduce what the problem is due to insufficient or unclear information.\n"
            "- If the incident has MULTIPLE problems (e.g., flat tire + engine noise), you CAN still classify it. Choose the most appropriate category or use 'otros' if multiple issues exist. This is NOT ambiguous.\n"
            "- Set is_ambiguous=true ONLY in these cases:\n"
            "  * Evidence is completely insufficient to understand the problem (set category='incierto')\n"
            "  * Description is too vague or contradictory to make any reasonable deduction\n"
            "  * Confidence < 0.50 (very low confidence)\n"
            "- Multiple problems in one incident does NOT make it ambiguous - classify based on the primary or most urgent issue.\n"
